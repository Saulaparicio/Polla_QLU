      ...
      questions: [
        {
          ...
          a: "Los puntos se asignan bajo la siguiente estructura:\n\n• **Resultado Exacto (Marcador Perfecto):** 10 puntos (ej. pronosticas 2-1 y queda 2-1).\n• **Acertar Ganador/Empate:** 5 puntos (ej. pronosticas 3-1 y termina 2-0, o pronosticas 1-1 y termina 2-2).\n• **Aproximación en Partidos de Muchos Goles:** 3 puntos. Si el partido termina con una goleada de 5 o más goles en total (ej. 4-3) y fallaste por solo 1 gol de diferencia (ej. pronosticaste 3-3 o 4-2), te llevas este puntaje de consolación."
        },
        {
      ...
      questions: [
        {
          ...
          a: "Para activar tu cuenta debes realizar la transferencia de **B/.15** vía Yappy al número oficial del organizador. Luego, inicia sesión, ve a tu perfil/dashboard, adjunta la captura de pantalla de la transferencia como comprobante, y un administrador validará tu acceso en menos de 24 horas."
        }
      ]
    }
  ];
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="text-center sm:text-left mb-12 border-b border-white/10 pb-8 animate-fade-in">
          ...
          <p className="mt-3 text-[#5E7A9E] text-base leading-relaxed">
            Resuelve todas tus dudas sobre el reglamento del Prode 2026, sistema de puntos, desempates y registro de comprobantes.
          </p>
        </div>
