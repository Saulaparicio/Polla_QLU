            ...
            <div className="scoring-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
              <div className="tier featured bg-[#00E5FF]/5 p-6 text-center relative border-b lg:border-b-0 lg:border-r border-[#1C2E48] flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="tier-pts font-display text-5xl text-[#00E5FF] leading-none font-bold">3</div>
                  <div className="tier-pts-unit text-xs uppercase text-[#00E5FF] tracking-widest font-bold mt-1">Puntos</div>
                  <p className="tier-desc text-xs text-[#5E7A9E] leading-relaxed mt-4">¡Le pegaste al marcador idéntico! Goles exactos de cada equipo.</p>
                </div>
                <div className="tier-eg inline-block bg-[#152338] border border-[#1C2E48] rounded px-2 py-1.5 text-[11px] text-[#C5D2EE] font-mono mt-4">
                  Pred: 2-1 vs Real: 2-1
                </div>
              </div>
              <div className="tier p-6 text-center border-b sm:border-r lg:border-b-0 border-[#1C2E48] flex flex-col justify-between">
                <div>
                  <div className="tier-label text-xs uppercase text-[#5E7A9E] font-bold tracking-wider mb-3">⚖️ Diferencia de Goles</div>
                  <div className="tier-pts font-display text-5xl text-[#FFD700] leading-none font-bold">2</div>
                  <div className="tier-pts-unit text-xs uppercase text-[#FFD700] tracking-widest font-bold mt-1">Puntos</div>
                  <p className="tier-desc text-xs text-[#5E7A9E] leading-relaxed mt-4">Acertaste ganador y diferencia de goles, no el marcador exacto.</p>
                </div>
                <div className="tier-eg inline-block bg-[#152338] border border-[#1C2E48] rounded px-2 py-1.5 text-[11px] text-[#C5D2EE] font-mono mt-4">
                  Pred: 1-0 o 3-2 vs Real: 2-1
                </div>
              </div>
              <div className="tier p-6 text-center border-b lg:border-b-0 lg:border-r border-[#1C2E48] flex flex-col justify-between">
                <div>
                  <div className="tier-label text-xs uppercase text-[#5E7A9E] font-bold tracking-wider mb-3">🟢 Solo Ganador</div>
                  <div className="tier-pts font-display text-5xl text-[#5B8DEF] leading-none font-bold">1</div>
                  <div className="tier-pts-unit text-xs uppercase text-[#5B8DEF] tracking-widest font-bold mt-1">Punto</div>
                  <p className="tier-desc text-xs text-[#5E7A9E] leading-relaxed mt-4">Supiste quién ganaba, pero no el marcador ni la diferencia.</p>
                </div>
                <div className="tier-eg inline-block bg-[#152338] border border-[#1C2E48] rounded px-2 py-1.5 text-[11px] text-[#C5D2EE] font-mono mt-4">
                  Pred: 3-0 vs Real: 2-1
                </div>
              </div>
              <div className="tier p-6 text-center border-b sm:border-r lg:border-r lg:border-b-0 border-[#1C2E48] flex flex-col justify-between">
                <div>
                  <div className="tier-label text-xs uppercase text-[#5E7A9E] font-bold tracking-wider mb-3">🤝 Empate Exacto</div>
                  <div className="tier-pts font-display text-5xl text-[#E2E8F0] leading-none font-bold">3</div>
                  <div className="tier-pts-unit text-xs uppercase text-[#E2E8F0] tracking-widest font-bold mt-1">Puntos</div>
                  <p className="tier-desc text-xs text-[#5E7A9E] leading-relaxed mt-4">Acertaste empate y goles exactos. (Empate no exacto da 1 pt).</p>
                </div>
                <div className="tier-eg inline-block bg-[#152338] border border-[#1C2E48] rounded px-2 py-1.5 text-[11px] text-[#C5D2EE] font-mono mt-4">
