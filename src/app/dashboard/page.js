  ...
  if (authLoading || !user || loading) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-zinc-500 min-h-screen">
        ...
        <span className="text-sm font-semibold font-mono text-[#5E7A9E]">Cargando Quiniela Polla Mundialista...</span>
      </div>
    );
  }
    ...
    <div className="text-[#E8F0FF] min-h-screen">
      ...
      <div className="app-main">
        ...
        <main>
          ...
          {(permission !== "granted" || !displayUser?.pushTokens || displayUser.pushTokens.length === 0) && (
